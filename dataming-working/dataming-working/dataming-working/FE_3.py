...
with open('D:/1007studying/2021/DATA/train_FE.csv', 'r') as csv_file:
...
ts_csv_path = 'D:/1007studying/2021/DATA/test_FE.csv'
tr_csv_path = 'D:/1007studying/2021/DATA/train_FE.csv'
...
tr_ts.iloc[:test.shape[0],].to_csv('D:/1007studying/2021/DATA/ts_FE.csv')
tr_ts.iloc[test.shape[0]:,].to_csv('D:/1007studying/2021/DATA/tr_FE.csv')